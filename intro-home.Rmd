...
[Part II](Introductory-II.html) The second half of the introductory workshop will focus on how to create data some basic but powerful data summaries and some basic data visualization with the packages from the `tidyverse`.
